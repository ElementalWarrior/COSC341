...
namespace CircleMenu_CircleMenu {
    ...
    public partial class MainWindow: Window {
        ...
        public MainWindow() {
            ...
            this.MouseLeftButtonUp += CloseCircleMenu;
            this.circle_menu.MouseRightButtonUp += CloseCircleMenu;
        ...
        private void RightClick(object sender,MouseButtonEventArgs e) {
            ...
            circle_menu.Margin = new Thickness(thing.X - circle_menu.RenderSize.Width / 2,thing.Y - circle_menu.RenderSize.Height / 2,0,0);
            circle_menu.Visibility = Visibility.Visible;

            mTimer.Restart();
        }

        private void CloseCircleMenu(object sender,MouseButtonEventArgs e) {
            circle_menu.Visibility = Visibility.Hidden;
            e.Handled = true;
        }
